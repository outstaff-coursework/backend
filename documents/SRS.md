...
Каждый из сервисов должен гарантированно выдерживать нагрузку для компаний до 200 человек и моментально отвечать на запросы. В планах увеличить это число до 1000 человек.
### Требования к безопасности
Гарантируется, что данные о сотрудниках защищены и никакой человек не из организации не сможет достать информацию о сотрудниках.
### Требование к гибкости сервиса
Возможность удобно добавить новый сервис с новым функционалом к старым.
### Требование к интерфейсу
Интерфейс должен быть интуитивен для конечного пользователя.
